package edu.escuelaing.Taller.httpServer;
...
public class HttpServer {
    ...
    /**
     * Creates the message for tcp protocol
     * 
     * @param path
     * @return Message
     */
    ...
    /**
     * Proces the message from the clientSocket and sends it back
     * 
     * @param clientSocket
     * @return Runnable
     * @throws IOException
     */
    public Runnable processResponse(Socket clientSocket) throws IOException {
        return new Runnable() {
            @Override
            public void run() {
                try {
